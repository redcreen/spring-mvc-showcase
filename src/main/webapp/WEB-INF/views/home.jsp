...
<div id="tabs">
	<div title='forms' cache="false" href="<c:url value="/form" />"></div>
	<div title="fileupload" href="<c:url value="/fileupload" />"></div>
	<div title='simple'>
		<div id="simple">
		<h2>Simple</h2>
		<p>
